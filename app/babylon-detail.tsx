...
const TIMELINE_NODES = [
  { id: 'carchemish', title: 'BATTLE OF CARCHEMISH', date: '605 BC', icon: Shield, isSpecial: false },
...
export default function BabylonDetailScreen() {
  ...
  const headings = useMemo(() => extractHeadings(babylonContext), []);
  ...
  return (
    <View style={styles.container}>
      ...
      >
        {/* ── Hero Header Banner ────────────────────────────────────────── */}
        <ImageBackground
          source={require('../assets/Places/Babylon.png')}
        ...
        >
          ...
          >
            <Text style={styles.heroEyebrow}>THE BABYLONIAN EMPIRE</Text>
            <Text style={styles.heroTitle}>The Head of Gold</Text>
            <View style={styles.badgeContainer}>
              <Text style={styles.badgeText}>605–539 BC</Text>
            </View>
          </Animated.View>
        </ImageBackground>
        ...
        {activeTab === 'overview' && (
          <Animated.View style={{ opacity: fadeAnim }}>
            ...
            <View style={styles.factsWrapper}>
              <View style={styles.factsGrid}>
                ...
                <View style={styles.factCard}>
                  ...
                  <Text style={styles.factValue} numberOfLines={2}>Babylon</Text>
                </View>
                ...
                <View style={styles.factCard}>
                  ...
                  <Text style={styles.factValue} numberOfLines={2}>Nebuchadnezzar II</Text>
                </View>
                ...
                <View style={styles.factCard}>
                  ...
                  <Text style={styles.factValue} numberOfLines={2}>Daniel · Ezekiel</Text>
                </View>
                ...
                <View style={styles.factCard}>
                  ...
                  <Text style={styles.factValue} numberOfLines={2}>World Dominion</Text>
                </View>
              </View>
            </View>
            ...
            <View style={styles.sectionHeaderRow}>
              ...
              <Text style={styles.sectionTitleText}>EXPLORE THE BABYLONIAN EMPIRE</Text>
            </View>
        ...
        {activeTab === 'read' && (
          <ReadTabContent
            contextData={babylonContext}
            accentColor={ACCENT}
            headerEyebrow="THE BABYLONIAN EMPIRE"
            scrollRef={scrollRef}
            scrollY={scrollY}
